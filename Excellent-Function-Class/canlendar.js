...
!(function ($) {
    /*
    weekMap = {
        sc: ["周日", "周一", "周二", "周三", "周四", "周五", "周六"],//简体中文
        sc2: ["日", "一", "二", "三", "四", "五", "六"],
        en: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        en2: ["S", "M", "T", "W", "T", "F", "S"]
    }

    //状态 null(非本月) checkIn(入住) checkOut(离开)  weekend(周末) (workday)本月工作日 disable(不可选)
    function daterMap(data) {
        //var re = document.createElement('div');

        //re.className = "calendar-body";//<div class="calendar-body">
        ...
        html += "</tr>";
        var classes = ['weekend', 'workday', 'workday', 'workday', 'workday', 'workday', 'weekend', 'null', 'disable'];
        for (var i = 0, len = data.weeks.length; i < len; i++) {
            html += '<tr class="days">';
            for (var j = 0; j < 7; j++) {
                html += '<td class="' + classes[data.weeks[i][j][0]] + '" data-day="' + data.weeks[i][j][1] + '">';
    ...
    */
    ...
    !(function () {
        ...
        var data = daterMap({
            year: d.getFullYear() + '年',    //pass
            month: d.getMonth() + 1 + '月',  //pass
            weekStart: 0,                    //pass
            weekStyle: weekMap.sc,              //pass
            weeks: [[[0, "2014-07-28", 28], [0, "2014-07-29", 29], [0, "2014-07-30", 30], [0, "2014-07-31", 31], [3, "2014-08-01", 1], [3, "2014-08-02", 2], [3, "2014-08-03", 3]],
            [[3, "2014-07-28", 4], [3, "2014-07-29", 5], [3, "2014-07-30", 6], [1, "2014-07-31", 7], [1, "2014-08-01", 8], [2, "2014-08-02", 8], [2, "2014-08-03", 10]],
            [[1, "2014-07-28", 11], [1, "2014-07-29", 12], [1, "2014-07-30", 13], [1, "2014-07-31", 14], [1, "2014-08-01", 15], [2, "2014-08-02", 16], [2, "2014-08-03", 17]],
            [[1, "2014-07-28", 18], [1, "2014-07-29", 19], [1, "2014-07-30", 20], [1, "2014-07-31", 21], [1, "2014-08-01", 22], [2, "2014-08-02", 23], [2, "2014-08-03", 24]],
            [[1, "2014-07-28", 25], [1, "2014-07-29", 26], [1, "2014-07-30", 27], [1, "2014-07-31", 28], [1, "2014-08-01", 29], [2, "2014-08-02", 30], [2, "2014-08-03", 31]]]
